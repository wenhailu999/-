            ...
            if (toolcbxBaseType.SelectedItem != null)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow row in dtBaseType.Rows)
                    {
                        ...
                        intAmount = db.GetSingleObject("Select Count(*) From BSCustomer Where " + strCodeColumn + " = '" + row[strCodeColumn].ToString() + "'") as Nullable<int>;
                    ...
                    dr["Name"] = "未设定";
                    intAmount = db.GetSingleObject("Select Count(*) From BSCustomer Where " + strCodeColumn + " is null ") as Nullable<int>;
